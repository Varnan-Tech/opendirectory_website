...
export default function ClaimForm({ githubEmail }: { githubEmail: string }) {
  ...
  return (
    <div className="w-full max-w-2xl bg-card border border-border rounded-2xl p-8 shadow-xl">
      ...
      {error && (
        <div className="mb-8 p-4 bg-red-500/5 border border-red-500/30 rounded-2xl text-red-500 text-sm font-medium flex items-center justify-center gap-3 shadow-sm">
