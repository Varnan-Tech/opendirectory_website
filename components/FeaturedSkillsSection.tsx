        ...
        <div className="px-6">
          <InfiniteSlider gap={16} duration={80} pauseOnHover={true}>
            ...
            <motion.div
              ...
              className="w-[300px] sm:w-[340px] shrink-0 group relative flex flex-col bg-white border border-black/[0.08] rounded-xl overflow-hidden hover:border-[#856FE6]/35 hover:shadow-[0_6px_24px_rgba(133,111,230,0.11)] transition-[border-color,box-shadow] duration-200 cursor-pointer"
            >
